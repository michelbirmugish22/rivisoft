...
police1 = ParagraphStyle('p1', fontName='Helvetica-Bold', backColor='#000000', textColor='#FFFFFF')
police2 = ParagraphStyle('p2', fontName='Helvetica', backColor='#FFFFFF', textColor='#00000F')
...
def generate_invoice(request, reservation_id):
    ...
    # Ajouter le titre
    p1 = Paragraph("LISTE DES RESERVATIONS POUR LA DATE DE DEMAIN", police1)
    p2 = Paragraph("Voici la liste des réservation des chambres pour la date du 17/08/2024", police2)
    elements.append(p1)
    elements.append(p2)
